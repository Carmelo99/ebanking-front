...
import BankCardService, { BankCardServiceType } from './service/BankCardService';
...
function BankCard() {
  ...
  const {cardData,loading,tableActions} : BankCardServiceType = BankCardService();
  return (
    <>
    <CssBaseline />
    <MaterialTable
     components={{
      ...
      columns={[
        ...
        },
        {
          ...
          title: "Korisnik",
          render: (rowData:any) => {
            return rowData.card_owner.firstname+" "+rowData.card_owner.lastname;
          }
        },
      ]}
      data={cardData}
