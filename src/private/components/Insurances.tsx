...
import InsurancesService, { InsurancesServiceType } from './service/InsurancesService';
...
function Insurances() {
  ...
  const {insuranceData,loading,tableActions} : InsurancesServiceType = InsurancesService();
  return (
    <>
    <CssBaseline />
    <MaterialTable
     components={{
      ...
      columns={[
        ...
        },
        {
          ...
          title: "Tip osiguranja",
        },
        {
          field: "company",
          title: "Osiguravajuce drustvo",
          render: (rowData:any) => {
          return rowData.company.company_name;
        }
      },
      ]}
      data={insuranceData}
